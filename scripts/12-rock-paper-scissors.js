...
// we use setInterval to run every 1 second to play the game and then use return id stort in varaible 

// we use addEventListener instand of onclik.
...
document.querySelector('.js-scissors-button')
  ...
  // we use addEventListener on keydown to get parameter event.key to contain and then use if stament 
